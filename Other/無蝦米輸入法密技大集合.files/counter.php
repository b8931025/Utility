if (!self._FC2COUNTER3216059)
{
	var _FC2COUNTER3216059 =
	{
		id:3216059,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'http://panel.counter1.fc2.com/popup.php?id='+this.id;
...
T += counterh;
		...
		hide_graph:function(){
			if (this.graph_img)
			{
				this.graph_img.style.display="none";
			}
		},
		visit_info:function()
		{
		...
		disp_js:function()
		{
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="http://counter1.fc2.com/counter_js.php?id=' + this.id
