...
function AddLoveBlog(){
      ...
      window.open('http://admin.xuite.net/service/bookmark/bmAdd.php?url='+encodeURIComponent(document.URL)+'&name='+encodeURIComponent(document.title),'favorite','width=500,height=400,left=75,top=20,resizable=yes,scrollbars=yes,status=yes');
}
...
function getMouseXY(e) {
  if (IE) { // grab the x-y pos.s if browser is IE
    mLoc.x = event.clientX + document.documentElement.scrollLeft
    mLoc.y = event.clientY + document.documentElement.scrollTop
